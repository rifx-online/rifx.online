...
_These are free, rate-limited endpoints for [Llama 3.2 1B Instruct](/models/meta-llama/llama-3.2-1b-instruct). Outputs may be cached. Read about rate limits [here](/docs/limits)._
